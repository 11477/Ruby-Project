...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference("Discussion.count") do
      post discussions_url, params: { discussion: { content: @discussion.content, program_id: @discussion.program_id, text: @discussion.text } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { content: @discussion.content, program_id: @discussion.program_id, text: @discussion.text } }
