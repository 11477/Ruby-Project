...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference("Relation.count") do
      post relations_url, params: { relation: { project_id: @relation.project_id, user_id: @relation.user_id } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { project_id: @relation.project_id, user_id: @relation.user_id } }
